...
#import "FFButtonWithStyleGreenH30.h"

static NSString * const kButtonImageNormalState = @"button_green_30x30_normal.png";
static NSString * const kButtonImageHighlightedState = @"button_green_30x30_highlighted";
static NSString * const kButtonImageDisabledState = @"button_green_30x30_disabled.png";

@implementation FFButtonWithStyleGreenH30
