...
#import "FFButtonWithStyleRedH40.h"

static NSString * const kButtonImageNormalState = @"button_red_40x40_normal.png";
static NSString * const kButtonImageHighlightedState = @"button_red_40x40_highlighted";
static NSString * const kButtonImageDisabledState = @"button_red_40x40_disabled.png";

@implementation FFButtonWithStyleRedH40
