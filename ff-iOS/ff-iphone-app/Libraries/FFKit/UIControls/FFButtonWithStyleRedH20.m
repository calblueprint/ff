...
#import "FFButtonWithStyleRedH20.h"

static NSString * const kButtonImageNormalState = @"button_red_20x20_normal.png";
static NSString * const kButtonImageHighlightedState = @"button_red_20x20_highlighted";
static NSString * const kButtonImageDisabledState = @"button_red_20x20_disabled.png";

@implementation FFButtonWithStyleRedH20
